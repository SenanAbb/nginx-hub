...
LDAP_GROUP_SPECS=(
    ...
    "zeppelin_admin:Zeppelin Administrators:20014"
    "zeppelin_user:Zeppelin Users:20015"
    "grafana_admin:Grafana Administrators:20016"
    "grafana_user:Grafana Users:20017"
    "openmd_admin:OpenMD Administrators:20018"
    "openmd_user:OpenMD Users:20019"
    "airflow_admin:Airflow Administrators:20020"
    "airflow_user:Airflow Users:20021"
)
...
add_user_to_group "sp_admin" "zeppelin_admin"
add_user_to_group "sp_admin" "grafana_admin"
add_user_to_group "sp_admin" "openmd_admin"
add_user_to_group "sp_admin" "airflow_admin"
...
echo ""
echo "LDAP Admin UI:"
echo "  - sp_admin (groups: sp_admin, ambari_cluster_admin, ranger_admin, hue_admin, zeppelin_admin/user, grafana_admin/user, openmd_admin/user, airflow_admin/user)"
echo ""
